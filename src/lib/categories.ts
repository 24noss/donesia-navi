export const categories = {
  ...
  gourmet: {
    name: 'グルメ・レストラン',
    color: 'gourmet',
    description: 'ジャカルタの中華・イタリアン・韓国料理・日本食など、エリア別のおすすめレストラン・カフェ情報をお届けします。',
    seoTitle: 'グルメ・レストラン | ジャカルタのレストランおすすめ情報',
  },
  lifestyle: {
    name: '生活情報',
    color: 'lifestyle',
    description: 'ジャカルタでの日本人学校・病院探し、住居や買い物など、インドネシア生活に役立つ情報を発信します。',
    seoTitle: '生活情報 | インドネシアの生活・暮らし情報',
  },
  travel: {
    name: '旅行・お出かけ',
    color: 'travel',
